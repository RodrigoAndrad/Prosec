...
class ElementSeeder extends Seeder {
    ...
    public function run() {
        DB::table('elements')->insert([
            'id' => 1,
            'name' => 'Banner 1 da Homepage',
            'description' => 'Banner 1 Rotativo da Homepage',
        ]);

        DB::table('elements')->insert([
            'id' => 2,
            'name' => 'Banner 2 da Homepage',
            'description' => 'Banner 2 Rotativo da Homepage',
        ]);

        DB::table('elements')->insert([
            'id' => 3,
            'name' => 'Banner 3 da Homepage',
            'description' => 'Banner 3 Rotativo da Homepage',
        ]);

        DB::table('elements')->insert([
            'id' => 4,
            'name' => 'Box 1 da Homepage',
            'description' => 'Box 1 de navegação em destaque na Homepage',
        ]);

        DB::table('elements')->insert([
            'id' => 5,
            'name' => 'Box 2 da Homepage',
            'description' => 'Box 2 de navegação em destaque na Homepage',
        ]);

        DB::table('elements')->insert([
            'id' => 6,
            'name' => 'Box 3 da Homepage',
            'description' => 'Box 3 de navegação em destaque na Homepage',
        ]);

        DB::table('elements')->insert([
            'id' => 7,
            'name' => 'Box 4 da Homepage',
            'description' => 'Box 4 de navegação em destaque na Homepage',
        ]);
        ...
        DB::table('elements')->insert([
            ...
            'description' => 'Box 6 de navegação em destaque na Homepage',
        ]);

        DB::table('elements')->insert([
            'id' => 10,
            'name' => 'Destaque da Homepage',
            'description' => 'Destaque na Homepage',
        ]);
        ...
        DB::table('elements')->insert([
            'id' => 21,
            'name' => 'Box 1 de Serviços',
            'description' => 'Box 1 de Serviços',
        ]);

        DB::table('elements')->insert([
            'id' => 22,
            'name' => 'Box 2 de Serviços',
            'description' => 'Box 2 de Serviços',
        ]);

        DB::table('elements')->insert([
            'id' => 23,
            'name' => 'Box 3 de Serviços',
            'description' => 'Box 3 de Serviços',
        ]);

        DB::table('elements')->insert([
            'id' => 24,
            'name' => 'Box 4 de Serviços',
            'description' => 'Box 4 de Serviços',
        ]);

        DB::table('elements')->insert([
            'id' => 25,
            'name' => 'Box 5 de Serviços',
            'description' => 'Box 5 de Serviços',
        ]);

        DB::table('elements')->insert([
            'id' => 26,
            'name' => 'Box 6 de Serviços',
            'description' => 'Box 6 de Serviços',
        ]);

        DB::table('elements')->insert([
            'id' => 27,
            'name' => 'Box 7 de Serviços',
            'description' => 'Box 7 de Serviços',
        ]);

        DB::table('elements')->insert([
            'id' => 28,
            'name' => 'Box 8 de Serviços',
            'description' => 'Box 8 de Serviços',
        ]);

        DB::table('elements')->insert([
            'id' => 29,
            'name' => 'Box 9 de Serviços',
            'description' => 'Box 9 de Serviços',
        ]);
        ...
        DB::table('elements')->insert([
            'id' => 31,
            'name' => 'Box da Página de Vigilância Vigilância Patrimonial',
        ...
        DB::table('elements')->insert([
            'id' => 84,
            'name' => 'Conteudo 1 do Box 3 Página Conheça o Grupo Pro Security',
            'description' => 'Conteudo 1 do Box 3 da Página Conheça o Grupo Pro Security',
        ]);
        
        DB::table('elements')->insert([
            'id' => 85,
            'name' => 'Conteudo 2 do Box 3 Página Conheça o Grupo Pro Security',
            'description' => 'Conteudo 2 do Box 3 da Página Conheça o Grupo Pro Security',
        ]);

        DB::table('elements')->insert([
            'id' => 86,
            'name' => 'Conteudo 3 do Box 3 Página Conheça o Grupo Pro Security',
            'description' => 'Conteudo 3 do Box 3 da Página Conheça o Grupo Pro Security',
        ]);

        DB::table('elements')->insert([
            'id' => 87,
            'name' => 'Conteudo 4 do Box 3 Página Conheça o Grupo Pro Security',
            'description' => 'Conteudo 4 do Box 3 da Página Conheça o Grupo Pro Security',
        ]);

        DB::table('elements')->insert([
            'id' => 88,
            'name' => 'Conteudo 5 do Box 3 Página Conheça o Grupo Pro Security',
            'description' => 'Conteudo 5 do Box 3 da Página Conheça o Grupo Pro Security',
        ]);

        DB::table('elements')->insert([
            'id' => 89,
            'name' => 'Conteudo 6 do Box 3 Página Conheça o Grupo Pro Security',
            'description' => 'Conteudo 6 do Box 3 da Página Conheça o Grupo Pro Security',
        ]);
        ...
        DB::table('elements')->insert([
            'id' => 92,
            'name' => 'Box 1 da Página de Responsabilidade Social',
            'description' => 'Box 1 da Página de Responsabilidade Social',
        ]);

        DB::table('elements')->insert([
            'id' => 93,
            'name' => 'Box 2 da Página de Responsabilidade Social',
            'description' => 'Box 2 da Página de Responsabilidade Social',
        ]);

        DB::table('elements')->insert([
            'id' => 94,
            'name' => 'Box 3 da Página de Responsabilidade Social',
            'description' => 'Box 3 da Página de Responsabilidade Social',
        ]);

        DB::table('elements')->insert([
            'id' => 95,
            'name' => 'Box 4 da Página de Responsabilidade Social',
            'description' => 'Box 4 da Página de Responsabilidade Social',
        ]);

        DB::table('elements')->insert([
            'id' => 96,
            'name' => 'Box 5 da Página de Responsabilidade Social',
            'description' => 'Box 5 da Página de Responsabilidade Social',
        ]);
