            ...
            <div class="column is-10">
                <b-field :label="this.label + ':'"> 
                    <b-tooltip style="min-width: 100%;" label="Clique em Editar para Editar o Conteúdo">
                        <keep-alive>
                            <b-input style="min-width: 100%;" :placeholder="this.placeholderText" v-model="this.originalFieldValue" :id="this.name + 'Input'" type="text" min="1" max="256" :maxlength="256" :minlength="1" disabled required></b-input>
                        </keep-alive>
                    </b-tooltip>
                </b-field>
            </div>
