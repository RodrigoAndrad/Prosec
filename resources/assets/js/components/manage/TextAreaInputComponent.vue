            ...
            <div class="column is-10">
                <b-field :label="this.label + ':'">
                    <b-tooltip style="min-width: 100%" label="Clique em Editar para Editar o Conteúdo">
                        <textarea style="min-width: 100%; resize: none;" class="textarea" type="text" :placeholder="this.placeholderText" :id="this.name + 'Input'" v-html="this.fieldValue" disabled></textarea>
                    </b-tooltip>
                </b-field>
            </div>
            <div class="column">
                <div class="is-pulled-left"  style="padding-top: 40%">
