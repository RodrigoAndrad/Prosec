   ...
   <div @mouseleave="hideSlideControls($event)" @mouseover="showSlideControls($event)">
        <div class="columns">
            ...
            <div v-if="this.linkSwitch === true" class="column" id="switch">
                <slide-switch-component :linkValue="Array.isArray(this.banners[0].links) && this.banners[0].links.length ? 'Link Ativo' : 'Link Inativo' "></slide-switch-component>
            </div>
        </div>
        <figure><img :src="imageDir + this.banners[0].images[0].src" :alt="this.banners[0].images[0].alt" width="100%"></figure>
        <div v-if="this.controls == 1 || this.controls == 2" class="columns p-t-5" :id='"imageCtrlSlide"' style="display: none;">
            <div class="column">
         ...
         <b-modal :active.sync="isCardModalActive" :width="1024" :height="800" scroll="keep" :can-cancel="['button']" id="modalBanner" v-on:ajax-complete="returnToast('is-success','Alteração salva com sucesso!')">
            <div class="card">
                ...
                <b-field label="Texto Alternativo:" class="m-l-10 m-r-10 m-t-5">
                        <b-input v-model="this.banners[0].images[0].alt" maxlength="256" type="is-danger"></b-input>
                </b-field>
