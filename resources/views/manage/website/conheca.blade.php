            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
		           ...
		           <div class="panel-content">
            	 	...
            	 	<div class="columns panel-content p-l-20 p-t-20">
		                <div class="column">
		                	<div>{{$pageIntroTitle->elementId}}</div>
		                	<div><h1>{{$pageIntroTitle->title}}</h1></div>
		                	@if( ! empty($pageIntroTitle->content) )
							<div><h2>{{$pageIntroTitle->content}}</h2></div>
		                	@else
		                	<div></div>
		                	@endif
		            	</div>
				   </div>
           		   <div class="panel-heading"><strong>Box Introdutório</strong></div>
            	 	<div class="columns panel-content p-l-20 p-t-20">
		                <div class="column">
		           ...
		           @endforeach  
		           <div class="panel-heading"><strong>{{$textIntroBox3->title}}</strong></div>
					...
					@endif            	 		
		                <div class="column">
		                	...
		                	<div><figure><img src="{{asset($cert->imageSrc)}}" width="50%"></figure></div>
		                	<div>{{$cert->imageSrc}}</div>
		                	<div>{{$cert->imageAlt}}</div>
		            	</div>
				   @if($loop->iteration % 3 === 0)		            	
				   </div>
				   @endif
