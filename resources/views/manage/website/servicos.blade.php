                ...
                <div class="panel-body">
		           ...
		           <div class="panel-content">
					...
					@endif            	 		
		                <div class="column">
		                	<div>{{$key}}</div>
		                	<div><figure><img src="{{asset($box->imageSrc[0])}}" width="20%"></figure></div>
		                	<div>{{$box->imageSrc[0]}}</div>
		                	<div>{{$box->imageAlt[0]}}</div>
		                	<div><figure><img src="{{asset($box->imageSrc[1])}}" width="100%"></figure></div>
		                	<div>{{$box->imageSrc[1]}}</div>
		                	<div>{{$box->imageAlt[1]}}</div>
		                	<div>{{$box->link}}</div>
		                	<div>{{$box->linkTarget}}</div>
