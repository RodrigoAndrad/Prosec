    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><h1><strong>Fale Conosco</strong> - {{$page->slug}}</h1></div>
				...
				<b-collapse :open.sync="boxIsOpen">
	         	    ...
	         	    @foreach($links['elements'][0]['links'] as $link)
	         	    	<div class="columns panel-content p-l-20 p-t-20">
							<div class="column is-manager-card box-component m-r-5 m-l-5">
			            		<multi-link-box-component name="linkBox" :link="{{@json_encode($link)}}" :order="{{@json_encode($loop->iteration)}}"></multi-link-box-component>
							</div>	
						</div>
	       		 	@endforeach
	       		</b-collapse>
