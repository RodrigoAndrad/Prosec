    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><h1><strong>Nossos Clientes</strong> - {{$page->slug}}</h1></div>
				...
				<b-collapse :open.sync="bannerIsOpen">
       		    ...
       		    <b-collapse :open.sync="boxIsOpen">
	         	    ...
	         	    @foreach($logos['elements'] as $box)
	        	 	@if($loop->index  === 0 ||$loop->index % 4 === 0)
	        	 	<div class="columns m-r-5 m-l-5 m-t-5">
					@endif
					    <div class="column is-manager-card box-component m-r-5 m-l-5">
							<clientes-box-component 
		        	 			:banners="{{@json_encode($box)}}"
		        	 			:order="{{@json_encode($loop->iteration)}}"
