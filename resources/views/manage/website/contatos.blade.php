<?php
	$imageIntro['elements'][0]['texts'] = $textIntro['elements'][0]['texts'];
?>
            ...
            <div class="panel panel-default">
				...
				<b-collapse :open.sync="bannerIsOpen">
       			...
       			<b-collapse :open.sync="boxIsOpen">
	        	 	...
	        	 	@foreach($imageIntro['elements'] as $key => $box)
	        	 	@if($loop->index  === 0 ||$loop->index % 3 === 0)
	        	 	<div class="columns m-r-5 m-l-5 m-t-5">
					@endif            	 		
					    <div class="column is-manager-card box-component m-r-5 m-l-5" id="introBox">
