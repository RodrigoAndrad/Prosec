    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><h1><strong>Endereços e Telefones</strong> - {{$page->slug}}</h1></div>
		           ...
		           <div class="panel-content">
            	 	...
            	 	<div class="columns panel-content p-l-20 p-t-20">
		                <div class="column">
		                	...
		                	@if(!empty($textIntro->content))<div><h2>{{$textIntro->content}}</h2></div>@endif
		                	@if(!empty($imageIntro->imageSrc))
		                	<div><figure><img src="{{asset($imageIntro->imageSrc)}}" width="25%"></figure></div>
			                <div>{{$imageIntro->imageSrc}}</div>
			                <div>{{$imageIntro->imageAlt}}</div>
		                	@endif
		            	</div>
				   </div>
