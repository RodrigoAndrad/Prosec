           ...
           <div class="card-content">
                ...
                <form action="{{route('register')}}" method="POST" role="form">
                    ...
                    <div class="field">
                        ...
                        <p class="control">
                            <input class="input {{$errors->has('name') ? 'is-danger' : ''}}" type="text" id="name" placeholder="Your Name" value="{{old('name')}}" required> 
                        </p>
                        @if($errors->has('name'))
                    ...
                    <div class="field">
                        ...
                        <p class="control">
                            <input class="input {{$errors->has('email') ? 'is-danger' : ''}}" type="text" id="email" placeholder="name@example.com" value="{{old('enmail')}}" required> 
                        </p>
                        @if($errors->has('email'))
