    ...
    <section>
        ...
        <div class="col-smart-12 col-tablet-12 col-laptop-12 col-desktop-12">
            <div class="cont text-orca serv-intro">
                <h6><a href="index.html">HOME</a> / <a href="fale-conosco.html"> FALE CONOSCO</a> / SAC</h6>
        ...
        <form id="contact_form" enctype="multipart/form-data" action="mailsac.php" method="post">
            ...
            <div class="cont">
               ...
               <div class="cax">
                ...
                <div class="cax">
                    ...
                    <input id="tel" class="input" name="tel" size="30" value="(DDD)Número" type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' required="required" data-inputmask-clearmaskonlostfocus="true"><br>
                </div>
   ...
   $('*').keydown( function(e) {
    ...
    <script>
        ...
        $( "#contact_form" ).submit(function( event ) {
          ...
          // Get some values from elements on the page:
            ...
            adm = $( this ).find( "input[name='adm']" ).val(),
            tel = $( this ).find( "input[name='tel']" ).val(),
            tel2 = $( this ).find( "input[name='tel2']" ).val(),
            end = $( this ).find( "input[name='end']" ).val(),
            compl = $( this ).find( "input[name='compl']" ).val(),
            ...
            {
                $( this ).find("input[name='name']").val('“Nome do Responsável” é obrigatório');
                $( this ).find("input[name='name']").css('color', 'red');
                send = 0;
            }

            if(tel === null || tel === "(DDD)Número" || tel === 'O "Telefone 1" é obrigatório')
            {
                $( this ).find("input[name='tel']").val('O "Telefone 1" é obrigatório');
                $( this ).find("input[name='tel']").css('color', 'red');
                send = 0;
            }
            else if (tel) {};
            if(email === null || email === "Digite seu email" || email == "O campo e-mail é obrigatório")
            {
                $( this ).find("input[name='email']").val('O campo e-mail é obrigatório');
    ...
    <script>
        ...
        $( "#newsForm" ).submit(function( event ) {
          ...
          // Get some values from elements on the page:
          newsEmail = $( this ).find( "input[name='newsEmail']" ).val(),
          url = $( this ).attr( "action" );
